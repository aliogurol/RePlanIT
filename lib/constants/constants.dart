...
// scenarios
List<String> tempScenarios = [
  'A1 Replace 3 servers by 1 next generation model',
  'A2 Upgrade all RAM to xxxx',
  'A3 Decrease capacity by 10%',
  'A4 Change to eco mode',
  'A5 Change power settings',
