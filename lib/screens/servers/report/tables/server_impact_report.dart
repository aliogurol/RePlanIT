...
class _ServersImpactReportTableState extends State<ServersImpactReportTable> {
  Widget build(BuildContext context) {
    final firstScenario = tempImpactReportScenarios.first;
    final secondScenario = tempImpactReportScenarios.where((element) => element['ghgEmissions'] == '22').first;
    final thirdScenario = tempImpactReportScenarios.where((element) => element['ghgEmissions'] == '-330').first;
    final forthScenario = tempImpactReportScenarios.where((element) => element['ghgEmissions'] == '-100').first;
    final fifthScenario = tempImpactReportScenarios.where((element) => element['ghgEmissions'] == '-90').first;
    final lastScenario = tempImpactReportScenarios.last;
      ...
      child: Table(
        children: [
          ...
          TableRow(
            ...
            children: buildTableCells(firstScenario)
          ),
          TableRow(
            decoration: BoxDecoration(
              color: Colors.grey[200],
            ),
            children: buildTableCells(secondScenario)
          ),
          TableRow(
            decoration: BoxDecoration(
              color: Colors.white,
            ),
            children: buildTableCells(thirdScenario)
          ),
          TableRow(
            decoration: BoxDecoration(
              color: Colors.grey[200],
            ),
            children: buildTableCells(forthScenario)
          ),
          TableRow(
            decoration: BoxDecoration(
              color: Colors.white,
            ),
            children: buildTableCells(fifthScenario)
          ),
          TableRow(
            decoration: BoxDecoration(
              color: Colors.grey[200],
            ),
            children: buildTableCells(lastScenario)
          ),
          TableRow(
            decoration: BoxDecoration(
              color: Colors.grey[200],
            ),
            children: buildTotals()
          ),
          TableRow(
            decoration: BoxDecoration(
              color: Colors.grey[200],
            ),
            children: buildKPNTargets()
          ),
        ]
      ),
    );
    ...
    return [
      TableCell(
        child: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text('-500 kgCO2eq.', style: greenStyle),
            ),
          ],
        ),
      ),
      TableCell(
        child: Column(
          ...
          children: [
            Padding(
              child: Text('-€ 500,-', style: greenStyle),
              padding: const EdgeInsets.all(8.0),
            ),
          ],
        ),
      ...
      TableCell(
        child: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text('2340 kg.', style: greenStyle),
            ),
          ],
        ),
      ),
      TableCell(
        child: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text('2390 kg.', style: greenStyle),
            ),
          ],
        ),
      ),
      ...
      TableCell(
        child: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text('-500 kWh', style: greenStyle),
            ),
          ],
        ),
      ),
