...
import 'package:responsive_admin_dashboard/screens/components/use_time.dart';
                    ...
                    Expanded(
                      ...
                      child: Column(
                        children: [
                          ...
                          if (Responsive.isMobile(context)) Suggestions(),
                          if (Responsive.isMobile(context))
                            SizedBox(
                              height: appPadding,
                            ),
                          if (Responsive.isMobile(context)) UseTime(),
                        ],
                      ),
                    ),
                    if (!Responsive.isMobile(context))
